"""
TF-IDF + SVM baseline for PAN 2026 Voight-Kampff AI Detection.
...
def load_model():
    # TODO: load fitted TfidfVectorizer + SVC (with probability=True) pipeline
    raise NotImplementedError("load_model() not yet implemented")


def predict_scores(model, texts):
    # TODO: return a list of float scores in [0, 1], one per text
