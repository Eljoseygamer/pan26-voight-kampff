"""
Zero-shot RoBERTa detector for PAN 2026 Voight-Kampff AI Detection.
...
Approach: uses a pretrained RoBERTa-based AI-text detector off the shelf
(no task-specific fine-tuning), e.g. roberta-base-openai-detector or similar.
"""
import json
import os
import sys
...
def load_model():
    # TODO: load pretrained RoBERTa detector (tokenizer + sequence classification head)
